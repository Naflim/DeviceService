...
namespace DeviceService.Model
{
    ...
    public partial class Register
    {
        ...
        private ushort devTypeField;

        private uint deviceIDField;

        private uint passwordField;

        private string hostSWVersionField;
        ...
        /// <remarks/>
        public string HostSWVersion
        {
            get
            {
                return this.hostSWVersionField;
            }
            set
            {
                this.hostSWVersionField = value;
            }
        }
